...
export default function ImageViewer(props){
	...
	function getImageUrl(){
		...
		if( '' === imgUrl ){
			imgUrl = 'string' === typeof MediaPageStore.get( 'media-original-url' ) ? MediaPageStore.get( 'media-original-url' ).trim() : '';
		}
	...
	return ( ! image ? null : <div className="viewer-image-container"><img src={ image } alt={ MediaPageStore.get('media-data').title || null } /></div> );
}
