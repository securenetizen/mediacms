...
export function ManageCommentsItemHeader(props){
	...
	return ( <div className="item manage-item manage-item-header manage-comments-item">
				<div className="mi-checkbox"><input type="checkbox" checked={ isSelected } onChange={ checkAll } /></div>
				<div className="mi-author">Author</div>
				<div id="text" onClick={ sortByColumn } className={ 'mi-comment mi-col-sort' + ( 'text' === sort ? ( 'asc' === order ? ' asc' : ' desc' ): '' ) }>Comment<div className="mi-col-sort-icons"><span><MaterialIcon type="arrow_drop_up" /></span><span><MaterialIcon type="arrow_drop_down" /></span></div></div>
