...
ItemsInlineSlider.prototype.nextSlide = function(){
	this.state.currentSlide = Math.min( calcCurrentSlide( this.data.dom.wrapper, this.data.item.width, this.state.currentSlide ) + this.state.slideItems, this.state.maxSlideIndex );
};

ItemsInlineSlider.prototype.previousSlide = function(){
	this.state.currentSlide = Math.max( 1, calcCurrentSlide( this.data.dom.wrapper, this.data.item.width, this.state.currentSlide ) - this.state.slideItems );
};
