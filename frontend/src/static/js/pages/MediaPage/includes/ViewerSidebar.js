...
export default class ViewerSidebar extends React.PureComponent {
	...
	render(){
		return <div className="viewer-sidebar">
					{ this.state.isPlaylistPage ? <PlaylistView activeItem={ this.state.activeItem } playlistData={ this.props.playlistData } /> : ( 'video' === this.state.mediaType || 'audio' === this.state.mediaType ? <AutoPlay/> : null ) }
